                ...
                <div class="ibox-content">
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-12 col-xs-12">
                            ...
                            <asp:TextBox ID="txtCpf" runat="server" CssClass="form-control" MaxLength="11" TextMode="Number" onKeyDown="if(this.value.length>10 && event.keyCode!=8) return false;"></asp:TextBox>
                        </div>
                        <div class="col-md-2 col-sm-12 col-xs-12">
                            <label>
                                RG
                        ...
                        <div class="col-md-2 col-sm-12 col-xs-12">
                            ...
                            <asp:TextBox ID="txtTelefone" runat="server" CssClass="form-control" MaxLength="20" TextMode="Number" onKeyDown="if(this.value.length>19 && event.keyCode!=8) return false;"></asp:TextBox>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 col-sm-12 col-xs-12">
                        ...
                        <div class="col-md-3 col-sm-12 col-xs-12">
                            ...
                            <asp:TextBox ID="txtDataNascimento" runat="server" CssClass="form-control" placeholder="DD/MM/YYYY" TextMode="Date"></asp:TextBox>
                        </div>
                    </div>
                </div>
            </div>
